      ...
      <footer className="footer">
        <div className="container-fluid">
          <div className="d-sm-flex justify-content-center justify-content-sm-between py-2 w-100">
            ...
            <span className="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Developed By <a href="" target="_blank" rel="noopener noreferrer"> </a>Morshed Alam,Abul Kalam, Manik Saha</span>
          </div>
        </div>
      </footer>
    );
