                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="btn_section btn_style">
                            <a href="/hr/new-department" className="btn btn-primary gap"><i className="bi bi-plus-square"></i>New Department</a>
                            <a href="" className="btn btn-info gap"><i className="bi bi-person-bounding-box"></i>HR</a>
                            <a href="" className="btn btn-success gap"><i className="bi bi-cash-stack"></i>Accounts</a>
