        ...
        <div className="card">
          <div className="card-body">
            ...
            <div className="btn_section btn_style">
              <a href="" className="btn btn-primary gap">
                <i className="bi bi-person-rolodex"></i>Chef
              </a>
              <a href="" className="btn btn-info gap">
                <i className="bi bi-person-bounding-box"></i>Manager
              </a>
              <a href="" className="btn btn-success gap">
                <i className="bi bi-person-circle"></i>Waiter
              </a>
              <a href="" className="btn btn-warning gap">
                <i className="bi bi-person-workspace"></i>Sales & Marketing
              </a>
              <a href="" className="btn btn-primary gap">
                <i className="bi bi-calendar3"></i>Report By Date
              </a>
              <a href="" className="btn btn-info gap">
                <i className="bi bi-view-list"></i>Report By ID
              </a>
            </div>
            <br></br>
