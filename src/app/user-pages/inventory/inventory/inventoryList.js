        ...
        >
                <div className='emp-modal'>
                    ...
                    <p className="company_name2">
                            <span className="res2">Restaurant</span> FOOD</p>
                            </div>
                        <div className='border-box'>
                        <span><i className="icon-color bi bi-geo-alt-fill"></i> { restaurant? restaurant.address : null }</span> <br></br>  <br></br> 
                        <span><i className="icon-color bi bi-telephone-outbound-fill"></i> { restaurant? restaurant.phone : null }</span>  <br></br>   
                        <span><i className="icon-color bi bi-envelope-paper-fill"></i> { restaurant? restaurant.email : null }</span>    
                        </div>
                        <div>
        ...
        {detailsData ?
            <div>
                    ...
                    {supplier ?
                        ...
                        <span><i className="icon-color bi bi-envelope-paper-fill"></i>  { supplier.email}</span><br></br>
                        <span><i className="icon-color bi bi-telephone-outbound-fill"></i>  { supplier.phone}</span><br></br>
                        <span><i className="icon-color bi bi-geo-alt-fill"></i>  {supplier.address}</span></div>
                        : null}
                    <div className="close-btn">
                        <a onClick={invoiceModalClose}>
                            <i className="bi bi-x-square"></i>
                                ...
                                <div>
                                    <span>{detailsData[0].invoice_id}</span>
                                    <span>{detailsData[0].date}</span>
                                </div>
                </div>
                            ...
                            <table className="table table-bordered table-hover">
                                <tbody>
                                    <tr>
                                        <td>Total Price</td>
                                        <td>
                                            {supplier? supplier.total_price : null}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
