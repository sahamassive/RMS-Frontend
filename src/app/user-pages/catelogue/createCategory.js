                    ...
                    <div>
                        <div className="input_field two_part">
                            <div className="wid">
                                ...
                                <select className="select2" onChange={(event)=> {
                        ...
                        <div className="input_field two_part">
                            <div className="wid">
                                ...
                                <Form.Control type="text" placeholder="Category name" onChange={(event)=> {
                            ...
                            <div className="wid">
                                ...
                                <Form.Control type="number" placeholder="Discount ( % )" onChange={(event)=> {
                        ...
                        <div className="input_field two_part">
                            ...
                            <div className="wid">
                                ...
                                <Form.Control type="text" placeholder="URL" onChange={(event)=> {
                        ...
                        <div className="input_field">
                            <Form.Label className="level-style">Category image</Form.Label>
