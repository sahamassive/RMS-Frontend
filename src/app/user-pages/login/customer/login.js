...
function Login(props) {
    ...
    return (
        <div className={window.location.pathname == '/customer/login' ? 'background-2' : null}>
                                ...
                                <div className="login-wrap p-4 p-md-5">
                                    ...
                                    <form action="#" className="signin-form">
                                        <div className="form-group mb-3">
                                            <label className="label" for="name">Email/Phone</label>
                                            <Form.Control
                                                type="text"
                                        ...
                                        <div className="form-group">
                                            ...
                                            >Sign In <i className="bi bi-box-arrow-in-right"></i></button>
                                        </div>
                                    ...
                                    <p className="text-center">Not a member? <a data-toggle="tab" href="/customer/register">Sign Up</a></p>
                                    {window.location.pathname == '/customer/login' ? 
